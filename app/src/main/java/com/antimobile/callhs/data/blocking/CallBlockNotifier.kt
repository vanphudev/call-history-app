...
/** Notification do CallHS tự gửi sau khi đã chặn cuộc gọi qua CallScreeningService. */
object CallBlockNotifier {
    ...
    internal fun notificationSoundUri(context: Context, sound: BlockNotificationSound): Uri {
        ...
        val resourceId = when (sound.preset ?: BlockNotificationSoundPreset.PULSE) {
            BlockNotificationSoundPreset.PULSE -> R.raw.callhs_pulse
            BlockNotificationSoundPreset.RIPPLE -> R.raw.callhs_ripple
            BlockNotificationSoundPreset.BAMBOO -> R.raw.callhs_bamboo
            BlockNotificationSoundPreset.CRYSTAL -> R.raw.callhs_crystal
        }
        return Uri.Builder()
