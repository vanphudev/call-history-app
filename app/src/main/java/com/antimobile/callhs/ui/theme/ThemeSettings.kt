 ...
 *
 * Đồng bộ cách làm với [com.antimobile.callhs.i18n.LanguageSettings] và
 * [com.antimobile.callhs.util.FontScaleSettings]: lưu bằng SharedPreferences + giữ snapshot-state để đổi chế độ
...
object ThemeSettings {
     ...
     * Lý do: [com.antimobile.callhs.MainActivity.attachBaseContext] ghim fontScale bằng cách SAO NGUYÊN
     ...
     * ánh cấu hình thiết bị hiện thời — đúng cách [com.antimobile.callhs.i18n.Lang] đã xử lý cho LOCALE.
     */
