...
val LightPalette = Palette(
    ...
    scrollTopScrim = Color(0x8A2E3033),
    scrollTopSolid = Color(0xF23C4043),
...
val DarkPalette = Palette(
    ...
    scrollTopScrim = Color(0x992A2D30),  // lớp kính mờ nút "lên đầu" (icon trắng vẫn rõ)
    scrollTopSolid = Color(0xF22A2D30),  // fallback < Android 12
