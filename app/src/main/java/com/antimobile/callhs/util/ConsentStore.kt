 ...
 *
 * Đây là điều kiện BẮT BUỘC (cùng với 3 quyền hệ thống) để vào ứng dụng — xem
 * [com.antimobile.callhs.ui.permissions.PermissionGate]. Chỉ hỏi MỘT lần; đã đồng ý thì các lần mở
 * sau bỏ qua màn này.
 *
