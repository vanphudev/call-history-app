 ...
 * cài đặt hiển thị bằng singleton + snapshot-state (xem [com.antimobile.mcas.util.FontScaleSettings]).
...
interface MessagingStrings {
    ...
    val mmsLabel: String
    val downloadMms: String
    val downloadingMms: String
    val mmsDownloadFailed: String
    val imageProcessing: String
    val mmsConfirmTitle: String
    val mmsConfirmBody: String
    val sendMms: String
    val imageUnreadable: String
    val imageTooLarge: String
    val subjectTooLong: String
    val mmsDisabled: String
    val mobileDataDisabled: String
...
/** Chuỗi DÙNG CHUNG nhiều màn: nhãn điều hướng, nút quyền, và toast của [com.antimobile.mcas.util.CallActions]. */
...
interface SettingsStrings {
    ...
    val mmsAutoDownloadTitle: String
    val mmsAutoDownloadSubtitle: String
    val mmsRoamingTitle: String
    val mmsRoamingSubtitle: String
...
/** Nhãn CỠ CHỮ (mức + màn chọn) — mức đổi theo ngôn ngữ, resolve từ [com.antimobile.mcas.util.FontScaleSettings.Tier]. */
...
/** Chuỗi onboarding: 3 quyền nền tảng + bước SMS mặc định + Điều khoản cuối. */
interface PermissionStrings {
    ...
    val smsStep: String
    val smsHeadline: String
    val smsDesc: String
    val smsBullet1: String
    val smsBullet2: String
    val smsBullet3: String
    val smsRoleDeniedMessage: String
 ...
 * [com.antimobile.mcas.util.AppLinks], [com.antimobile.mcas.util.ContactActions],
 * [com.antimobile.mcas.util.PhoneActions], [com.antimobile.mcas.util.ShareContact].
 */
 ...
 * và cài đặt hiển thị.
 * Nhật ký cuộc gọi hệ thống là chỉ-đọc nên không được sao lưu; lịch sử chặn do MCAS tự ghi thì có.
 */
