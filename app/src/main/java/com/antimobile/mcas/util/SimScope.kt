 ...
 *
 * Đồng bộ cách làm với [com.antimobile.mcas.ui.theme.ThemeSettings] / [com.antimobile.mcas.i18n.LanguageSettings]:
 * SharedPreferences + snapshot-state để đổi là cả app nạp lại NGAY. Lọc được ÁP TẠI GỐC (một chỗ duy nhất:
 * [com.antimobile.mcas.data.repository.CallLogRepository]) nên mọi màn tự tuân theo, không phải sửa từng màn.
 *
