 ...
 *
 * Vì sao tự quản: thiết kế của app dựa trên thang chữ [com.antimobile.mcas.ui.theme.Typography] cố định
 * (heading đậm, letter-spacing siết). Nếu để hệ điều hành phóng chữ theo cài đặt của máy (nhiều máy đẩy tới
 * 150–200%) thì layout dễ VỠ. Nên app CHẶN cỡ chữ hệ thống (xem [com.antimobile.mcas.MainActivity]
 * attachBaseContext ghim fontScale = 1.0) và CHỈ áp HỆ SỐ do người dùng chọn ở đây (xem
 * [com.antimobile.mcas.ui.theme.MCASTheme] override LocalDensity).
 *
