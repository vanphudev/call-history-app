package com.antimobile.mcas.data.messaging.model
...
enum class MmsDownloadState { NONE, PENDING, DOWNLOADING, DOWNLOADED, FAILED, EXPIRED }
...
data class SmsMessageItem(
    ...
    val mmsDownloadState: MmsDownloadState = MmsDownloadState.NONE,
) {
    val stableId: String get() = "${transport.name}:$id"
}
