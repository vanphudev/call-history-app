package com.antimobile.mcas.data.agency

import android.content.Context
import com.antimobile.mcas.data.remote.RemoteFileCache
import com.antimobile.mcas.data.remote.RemoteOrigin
...
class AgencyRepository(context: Context) {
    ...
    companion object {
         ...
         * [com.antimobile.mcas.util.AppMigrations] khi bản cập nhật đổi dữ liệu danh bạ.
         *
         * BLOCKING (đĩa).
         */
