...
import com.antimobile.mcas.receiver.messaging.MarkConversationReadReceiver
import com.antimobile.mcas.receiver.messaging.NotificationReplyReceiver
...
object MessageNotifier {
    ...
    fun notifyIncoming(
        ...
        val user = Person.Builder().setName("MCAS").setKey("mcas-self").build()
